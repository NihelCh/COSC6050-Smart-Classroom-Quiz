...
<header>
	...
	<div id="myModal" class="modal">
		<form action="php/CreateClass2.php" class="form-container" method="POST">
			<h2>Create class</h2>
...
<main>
	<div class="content-box">
		...
		$query= "SELECT * FROM subject_image INNER JOIN class ON subject_image.subject = class.subject"; 
